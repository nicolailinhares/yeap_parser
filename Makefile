...
test: dict
	...
	clang -ggdb3 -O0 -Qunused-arguments -std=c11 -Wall -Werror -Wextra -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow -o test.out tests.o unit_test.o dict_tests.o dict.o -lm

clean:
	rm dict.o dict_tests.o unit_test.o tests.o test.out
