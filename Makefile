...
test: dict int_stack json_decode
	...
	clang -ggdb3 -O0 -Qunused-arguments -std=c11 -Wall -Werror -Wextra -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow -o test.out tests.o unit_test.o stack_tests.o json_decode_tests.o dict_tests.o dict.o int_stack.o json_decode.o -lm

clean:
	rm dict.o int_stack.o json_decode.o dict_tests.o json_decode_tests.o stack_tests.o unit_test.o tests.o test.out
